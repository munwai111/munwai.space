...
const HeroProfile = ({ deviceInfo = {} }) => {
  ...
  const getResponsiveSizes = () => {
    if (deviceInfo.isFlipPhone) {
      ...
      return {
        containerSize: "w-full h-full lg:w-110 lg:h-110",
        imageSize: "w-40 h-40 lg:w-200 lg:h-200",
        iconSize: "w-10 h-10 lg:w-12 lg:h-12",
        ringSize: "w-48 h-48 lg:w-112 lg:h-112",
        outerRingSize: "w-80 h-80 lg:w-111 lg:h-111",
        ring1Size: "w-48 h-48 lg:w-104 lg:h-104",
        ring2Size: "w-48 h-48 lg:w-96 lg:h-96",
        avatarSize: "w-88 h-88 lg:w-88 lg:h-88",
      };
    }
    // Default fallback (desktop or safe values)
    return {
      containerSize: "w-full h-full lg:w-110 lg:h-110",
      imageSize: "w-40 h-40 lg:w-48 lg:h-48",
      iconSize: "w-12 h-12 lg:w-16 lg:h-16",
      ringSize: "w-48 h-48 lg:w-112 lg:h-112",
