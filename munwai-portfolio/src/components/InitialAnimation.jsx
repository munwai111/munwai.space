...
const InitialAnimation = ({ onComplete }) => {
  ...
  const onCompleteRef = useRef(onComplete); // Store onComplete in ref to prevent re-runs

  // Update ref when onComplete changes (but don't restart animation)
  useEffect(() => {
  ...
  useEffect(() => {
    // #region agent log
    fetch("http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        location: "InitialAnimation.jsx:172",
        message: "useEffect RUNNING",
        data: { phase, hasCanvas: !!canvasRef.current },
        timestamp: Date.now(),
    ...
    const startAnimation = () => {
      ...
      console.log(
        "[DEBUG] Animation starting - startTime:",
        startTime,
        "currentTime:",
        performance.now()
      );
      ...
      // #region agent log
      fetch(
        "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            location: "InitialAnimation.jsx:177",
            message: "Animation start",
            data: { startTime, currentTime: performance.now() },
            timestamp: Date.now(),
            sessionId: "debug-session",
            runId: "run1",
            hypothesisId: "B",
      ...
      const animate = (currentTime) => {
        ...
        fetch(
          "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
          {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
              location: "InitialAnimation.jsx:182",
              message: "Animation frame",
              data: { elapsed, currentTime, startTime, phase },
              timestamp: Date.now(),
              sessionId: "debug-session",
              runId: "run1",
              hypothesisId: "A",
        ...
        if (rect.width === 0 || rect.height === 0) {
          ...
          fetch(
            "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
            {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                location: "InitialAnimation.jsx:186",
                message: "Early return - invalid dimensions",
                data: {
        ...
        if (elapsed < 3) {
          ...
          fetch(
            "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
            {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                location: "InitialAnimation.jsx:224",
                message: "Phase 0 active",
                data: { elapsed, phase: 0 },
                timestamp: Date.now(),
                sessionId: "debug-session",
                runId: "run1",
                hypothesisId: "E",
        ...
        // Phase 1: Magnetic pull to center (3-5.5 seconds) - particles fade in during this phase
          ...
          fetch(
            "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
            {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                location: "InitialAnimation.jsx:239",
                message: "Phase 1 active",
                data: { elapsed, phase: 1 },
                timestamp: Date.now(),
                sessionId: "debug-session",
                runId: "run1",
                hypothesisId: "E",
        ...
        // Phase 2: Explosion (5.5-7.5 seconds) - match landing page behavior
          ...
          fetch(
            "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
            {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                location: "InitialAnimation.jsx:399",
                message: "Phase 2 active - EXPLOSION",
                data: { elapsed, phase: 2 },
                timestamp: Date.now(),
                sessionId: "debug-session",
                runId: "run1",
                hypothesisId: "E",
        ...
        // Simple fade out - keep background at 4th color, just fade overlay
          ...
          fetch(
            "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
            {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                location: "InitialAnimation.jsx:560",
                message: "Phase 3 active - FADE OUT",
                data: { elapsed, phase: 3 },
                timestamp: Date.now(),
                sessionId: "debug-session",
                runId: "run1",
                hypothesisId: "E",
        ...
        // Complete - reveal main page (at 8.5 seconds)
          ...
          // #region agent log
          console.log(
            "[DEBUG] Completion check - elapsed:",
            elapsed,
            "hasCompleted:",
          ...
          fetch(
            "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
            {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                location: "InitialAnimation.jsx:661",
                message: "COMPLETION TRIGGERED",
                data: {
                  elapsed,
                  currentTime,
                  startTime,
          ...
          // Only complete once - prevent multiple calls
          if (
            !hasCompletedRef.current &&
            ...
            console.log("[DEBUG] Calling onComplete - elapsed:", elapsed);
            // #region agent log
            fetch(
              "http://127.0.0.1:7244/ingest/631a4e26-5ad8-4db1-86c2-4a2162ad2e84",
              {
                ...
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                  location: "InitialAnimation.jsx:664",
            ...
            // #endregion
            // Small delay to ensure animation fully completes visually
            setTimeout(() => {
        ...
        // Calculate current phase from elapsed time (don't use state to avoid re-renders)
        const currentPhase =
          elapsed < 3
            ? 0
            : elapsed < 5.5
    ...
    return () => {
      console.log("[DEBUG] useEffect CLEANUP - canceling animation");
      clearTimeout(timeoutId);
  ...
  }, []); // Empty deps - animation should only run once, onComplete stored in ref
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* A */}
            <path
              d="M450 90 L480 30 L510 90 M463 65 L497 65"
              strokeDasharray="180"
              strokeDashoffset={
                180 *
                (1 -
            ...
            {/* I */}
            <path
              d="M540 30 L540 90 M525 30 L555 30 M525 90 L555 90"
              strokeDasharray="130"
              strokeDashoffset={
                130 *
                (1 -
            ...
            {/* A */}
            <path
              d="M780 90 L810 30 L840 90 M793 65 L827 65"
              strokeDasharray="180"
              strokeDashoffset={
                180 *
                (1 -
            ...
            {/* C */}
            <path
              d="M890 35 Q890 30 875 30 L865 30 Q850 30 850 50 L850 70 Q850 90 865 90 L875 90 Q890 90 890 85"
              strokeDasharray="180"
              strokeDashoffset={
                180 *
                (1 -
            ...
            {/* E */}
            <path
              d="M920 30 L920 90 M920 30 L955 30 M920 60 L950 60 M920 90 L955 90"
              strokeDasharray="160"
              strokeDashoffset={
                160 *
                (1 -
